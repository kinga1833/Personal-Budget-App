...
<?php
	...
	/*poprzedni miesiac
	$liczbaDniWPoprzednimMiesiacu = date('t', mktime(0, 0, 0, date('m')-1, 1, date('Y')));
	$beginOfPeriodPoprzedniMiesiac = date('Y-'+ date('t', mktime(0, 0, 0, date('m')-1, 1, date('Y')))+'-d');
	echo $beginOfPeriodPoprzedniMiesiac;*/
